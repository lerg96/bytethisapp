...
<div id="fullpage">
    ...
    <section id="section1" class="section">
        <header>
            ...
            <h1 class="text-center bestlover">Byte This App<br>
                <small>@lang('messages.welcome')</small>
            </h1>
        </header>
    </section>
    <!-- Acerca -->
    ...
    <section id="section3" class="section">
            ...
            <div class="container">
                ...
                <div data-count="HIGH" class="col-md-3 col-xs-6 badge-green is-animated">
                    <div class="col-md-12 well">
                        <i class="devicon-php-plain colored center-block text-center"
        ...
        <div class="slide" id="slide3">
            <div class="container">
                ...
                <!-- Laravel -->
                <div data-count="HIGH" class="col-sm-4 col-sm-offset-0 col-xs-offset-3 col-xs-6 badge-green is-animated">
                    <div class="col-md-12 well">
    ...
    <section id="section4" class="section">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="@lang('messages.inname')"
                                       required="required">
                            </div>
                            <div class="form-group">
                                <label for="email">
                                ...
                                <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span>
                                    ...
                                    <input type="email" class="form-control" id="email" placeholder="@lang('messages.inmail')"
        ...
        <!-- grande -->
        <div data-aos="zoom-in" class="container hidden-xs">
